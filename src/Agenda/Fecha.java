...
/**
 * Agenda.Fecha es una clase que encapsula las variables enteras
...
public class Fecha {
    ...
    /**
     * Constructor de la clase Agenda.Fecha usado para definir
     ...
     *
     * @param fecha Agenda.Fecha que se quiere comprobar si coincide con la fecha del evento
     ...
     * otra fecha pasada como argumento de la función.
     *
     * @param fecha Agenda.Fecha que se quiere comprobar si es posterior
    ...
    /**
     * Retorna un objeto Agenda.Fecha a partir de una cadena de texto formateada.
     *
     * @param texto Cadena de texto con la fecha formateada
     * @return Agenda.Fecha del evento
     */
